...
from data_voxel_reshape import dikea_class_try
...
def train(args, io):
    ...
    print(1)
    train_loader=DataLoader(dikea_class_try('train'), num_workers=8,
...
def a_test(args, io):
    test_loader = DataLoader(dikea_class_try('test'), num_workers=8,
