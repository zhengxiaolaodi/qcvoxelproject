...
class sunrgbd_mulit_para(Dataset):#这是提取数据的一个类
    def __init__(self, partition):
        self.data_02, self.data_04, self.data_08,self.label,self.voxel_num_result,self.voxel_sequence_result,self.voxel_pointnum_result = load_data_multi(partition)
