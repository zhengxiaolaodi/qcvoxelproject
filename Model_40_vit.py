...
from Model_40_data import modelnet40_voxel
...
def positional_adding(x, voxel_sequence, cloud_len_list, d_model, max_len):
    """
...
class Attention(nn.Module):
    ...
    def forward(self, x, voxel_sequence, cloud_len_list):
        ...
        mask_map = get_attn_pad_mask(self.max_len+1, voxel_sequence, cloud_len_list)  #### 760 = cls + 759
...
class DGCNN_voxel_reshape(nn.Module):
    ...
    def forward(self, input, cloud_len_list, voxel_sequence):
        ...
        x = positional_adding(x, voxel_sequence, cloud_len_list, d_model=self.voxel_cls, max_len = self.max_len)             ########################
        x = self.dropout(x)
...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(modelnet40_voxel('test'), num_workers=8,
