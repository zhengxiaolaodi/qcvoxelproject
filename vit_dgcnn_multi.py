...
class voxel_dgcnn(nn.Module):
    def __init__(self, dim,point_num):
        super(voxel_dgcnn, self).__init__()
        self.k = 10  ## 指　voxel里最近邻点的个数

        self.point_num = point_num ## 指每个voxel中有多少点
...
class DGCNN_voxel_reshape(nn.Module):
    def __init__(self, num_classes,dim1,dim2,dim3, point_num1,point_num2,point_num3,depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
        self.voxel_cls1 = dim1
        self.voxel_embedding1 = voxel_dgcnn(dim1,point_num1)
        ...
        self.voxel_embedding2 = voxel_dgcnn(dim2,point_num2)
        ...
        self.voxel_embedding3 = voxel_dgcnn(dim3,point_num3)
