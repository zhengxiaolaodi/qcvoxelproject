...
class voxel_dgcnn(nn.Module):
    def __init__(self):
        ...
        self.point_num = 500 ## 指每个voxel中有多少点
        self.voxel_cls =  256 ## 可以理解成有多少类体素，比如墙面体素，地面体素，圆形体素等等. 即voxel_fea的dim
        #self.voxel_num = 417
        self.emb_dims = 1024
...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(modelnet40_40cls_10percls_voxel_pcd_vfh_cluster_label(), num_workers=8,
