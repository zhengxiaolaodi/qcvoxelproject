...
from data_voxel_reshape import ikea3d_data
...
def train(args, io):
    ...
    print(1)
    train_loader=DataLoader(ikea3d_data('train'), num_workers=8,
...
def a_test(args, io):
    test_loader = DataLoader(ikea3d_data('test'), num_workers=8,
